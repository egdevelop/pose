          ...
          {dataProducts.map((item) => (
            <label className="card-product">
              ...
              <div class="bg-white px-2 pt-2 pb-4 m-auto text-center radio-btn">
                ...
                <p className="font-semibold text-xs-custom mt-2 text-center">
                  {item.name}
                </p>
                <div className="hideText mb-4">
                  ...
                  <span className="text-center mx-auto font-bold text-sm-custom mt-4">
                    {item.price}
                  </span>
                  <span className="text-center mx-auto font-bold text-sm-custom mt-4">
                    Item
                ...
                <div className="hideElement mt-4 flex">
                  <button className="bg-abu px-2 py-1" onClick={decrementCount}>
                    -
                  </button>
                  <span className="text-center mx-auto font-bold text-sm-custom">
                    {count}
                  </span>
                  <button className="bg-abu px-2 py-1" onClick={incrementCount}>
                    +
                  </button>
                </div>
                <button
                  onClick={() => setShow(true)}
                  className="bg-biru rounded-full w-full mt-8 text-white px-2 py-2 text-xs-custom hideButton"
                >
                  Konfirmasi
                </button>
            ...
            <div className="flex items-center gap-x-6 justify-between mb-4">
              ...
              <div className="relative">
                ...
                <span>
                  <input
                    type="text"
                    className="bg-white w-full py-2 px-2 -ml-3 text-black rounded-lg"
                ...
                {dataProducts.map((item) => (
                  <label className="card-product">
                    ...
                    <div class="bg-white px-1 py-1 m-auto text-center radio-btn">
                      ...
                      <p className="font-bold fz-7 mt-2 text-center">
                        {item.name}
                      </p>
                      <div className="flex justify-between mt-2 pb-2">
                        <span className="text-center fz-7 mx-auto">
                          {item.weight}
                        </span>
                        <span className="text-center mx-auto font-bold fz-7">
                          {item.price}
                        </span>
                      </div>
                      <div className="flex justify-between custom-flex">
                        <div className="hideText mb-4">
                          <span className="text-center mx-auto font-bold fz-10 mt-4">
                            Item
                          </span>
                        </div>
                        <div className="hideElement mt-4 flex">
                          <button
                            className="bg-abu px-1 flex items-center justify-center h-3 mr-2"
                            onClick={decrementCount}
                          >
                            -
                          </button>
                          <span className="text-center mx-auto font-bold fz-10">
                            {count}
                          </span>
                          <button
                            className="bg-abu px-1 flex items-center justify-center h-3 ml-2"
                      ...
                      <button className="bg-biru rounded-full w-full my-1 text-white px-2 py-1 fz-9 hideButton">
                        Konfirmasi
                      </button>
                      <Modal onClose={() => setShow(false)} show={show}>
                        <p>This is modal body</p>
          ...
          <div className="shadow-md h-full fixed top-0 right-0 overflow-y-scroll overflow-x-hidden bg-white">
            ...
            <div className="w-44 h-full mt-9 p-2">
              ...
              <div className="grid grid-cols-6 my-2">
                <span className="col-span-4 font-semibold text-xs text-black">
                  Subtotal
                </span>
                <span className="col-span-2 font-semibold fz-8">
                  Rp22.000,-
                </span>
              </div>
              <div className="grid grid-cols-6 my-2">
                <span className="col-span-4 font-semibold fz-8 text-abu">
                  Diskon(10%)
                </span>
                <span className="col-span-2 font-semibold fz-8 text-abu">
                  Rp2.200,-
                </span>
              </div>
              <div className="grid grid-cols-6 my-2">
              ...
              <div className="flex text-center my-6">
                <Link className="bg-biru rounded-full w-full mt-2 text-white px-8 py-1 text-xs">
                  Bayar
                </Link>
              </div>
            </div>
